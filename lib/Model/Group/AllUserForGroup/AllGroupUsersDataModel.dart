class AllGroupUsersDataModel {
  ...
  int? isFollower;
  int? isFollowing;
  int? isGroupInviteSent;
  int? isMember;
  int? isGroupJoinReq;

  AllGroupUsersDataModel(
      {this.sId,
      this.firstName,
      this.lastName,
      this.email,
      ...
      this.isFollower,
      this.isFollowing,
      this.isGroupInviteSent,
      this.isMember,
      this.isGroupJoinReq});

  AllGroupUsersDataModel.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    ...
    isGroupInviteSent = json['is_group_invite_sent'];
    isMember = json['is_member'];
    isGroupJoinReq = json['is_group_join_req'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_group_invite_sent'] = this.isGroupInviteSent;
    data['is_member'] = this.isMember;
    data['is_group_join_req'] = this.isGroupJoinReq;
    return data;
  }
}
