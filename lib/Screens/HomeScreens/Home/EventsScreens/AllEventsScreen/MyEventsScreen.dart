...
Future<UsersEventsModel>? _getUsersEventList;
...
class _MyEventsScreenState extends State<MyEventsScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      _getUsersEventList = getAllUsersEventsUsers(context,"1","1000");
      setState(() {});
      _getUsersEventList!.whenComplete(() => () {});
    });
  }
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: FutureBuilder<UsersEventsModel>(
                future: _getUsersEventList,
