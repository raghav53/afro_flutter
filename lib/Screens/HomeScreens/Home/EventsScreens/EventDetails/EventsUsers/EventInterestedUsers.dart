...
class EventInterestedUsersPage extends StatefulWidget {
  String eventId = "";
  EventInterestedUsersPage({Key? key, required this.eventId}) : super(key: key);

  @override
  State<EventInterestedUsersPage> createState() =>
      _EventInterestedUsersPageState();
}
...
class _EventInterestedUsersPageState extends State<EventInterestedUsersPage> {
  @override
  void initState() {
    super.initState();

    Future.delayed(Duration.zero, () {
      _getUsers = getGoingEventUsers("1", context, widget.eventId.toString());
